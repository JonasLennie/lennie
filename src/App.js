...
import cv_img from './media/cv.png';
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>Jonas Lennie</h1>
        <h2>Incoming Forward Deployed Software Engineer at <a href={'https://www.palantir.com/uk/'}>Palantir <img className='icon' src={palantir} alt="Palantir Logo" /> <span className={'lighter'}>(2024)</span></a></h2>
        ...
        <div className="links-container">
          ...
          <a href="https://www.linkedin.com/in/jlennie"><img className='bigicon' src={linkedin} alt="LinkedIn Logo" /></a>
          <a href={cv}><img className='bigicon' src={cv_img} alt="CV Icon" /></a>
